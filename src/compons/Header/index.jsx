...
const Header = ({ openCartBoard }) => {
  const { cartCollection } = useContext(Storage)
    ...
    <header className="header">
      <div className="container">
        <nav className="header-navigation">
          <Link className="header-logotype" to="/">
            <img src="img/LOGO.svg" alt="Logo" />
            <div className="header-slogan">
              <h3>React Sneakers</h3>
              <span>Магазин реактивных кроссовок</span>
            </div>
          </Link>
          <ul className="header-menu">
            <li className="header-menu-item" onClick={openCartBoard}>
              ...
              <span>{totalPrice > 0 ? cartCollection.length + " шт | " + totalPrice + " RUB" : "Корзина"}</span>
            </li>
            <li className="header-menu-item">
              <Link className="header-menu-link" to="/favorite">
                <svg xmlns="http://www.w3.org/2000/svg" width="19" height="17" viewBox="0 0 19 17" fill="none">
                  ...
                  <defs>
                    <clipPath id="clip0_60_590">
                      <rect width="18.11" height="16.299" fill="none"/>
                    </clipPath>
                  </defs>
                </svg>
                <span>Желаемое</span>
